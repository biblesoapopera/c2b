          ...
          value: function render() {
            ...
            return React.createElement(
              ...
              React.createElement(
                ...
                React.createElement(
                  'div',
                  { className: 'audio btn ' + (activeType !== 'listen' && activeSlide && activeSlide.audio ? '' : 'hide'), onClick: this.audio.bind(this) },
                  React.createElement(
                    'div',
                    null,
                    React.createElement('div', null)
                ...
                React.createElement(
                  'div',
                  { className: 'next btn ' + (episodeData && this.state.slide !== episodeData.slides.length - 1 ? '' : 'hide'), onClick: this.next.bind(this) },
                  React.createElement(
                    'div',
                    null,
                    React.createElement('div', null)
