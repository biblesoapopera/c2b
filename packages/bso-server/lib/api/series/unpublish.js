...
System.register('bso-server/api/series/unpublish', ['babel-runtime/regenerator', 'babel-runtime/helpers/asyncToGenerator', '../helpers/fail', '../helpers/validationFail', 'mongoose'], function (_export, _context) {
  "use strict";
              ...
              while (1) {
                switch (_context2.prev = _context2.next) {
                  case 0:
                    ...
                    _context2.prev = 1;
                    _context2.next = 4;
                    return db.series.update({ _id: req.params.id }, { published: false });
