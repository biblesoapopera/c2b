...
System.register('bso-server/api/audio/update', ['babel-runtime/regenerator', 'babel-runtime/core-js/promise', 'babel-runtime/helpers/asyncToGenerator', 'path', 'crypto', '../helpers/fail', './helpers/checkFile', './helpers/checkFilename', './helpers/checkMime'], function (_export, _context) {
  "use strict";
              ...
              while (1) {
                switch (_context2.prev = _context2.next) {
                  ...
                  case 13:
                    ...
                    return _context2.abrupt('return', fail(res, 'file does not exist', next));
