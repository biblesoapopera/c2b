...
System.register('bso-server/api/episodeImg/delete', ['babel-runtime/regenerator', 'babel-runtime/helpers/asyncToGenerator', 'path', 'del', '../helpers/checkFilename'], function (_export, _context) {
  "use strict";
            ...
            return _regeneratorRuntime.wrap(function _callee$(_context2) {
              while (1) {
                switch (_context2.prev = _context2.next) {
                  ...
                  case 2:
                    _context2.next = 4;
                    return del([path.join(episodeImgDir, req.params.file + '.jpeg')]);
