...
System.register('bso-server/api/user/logout', ['babel-runtime/regenerator', 'babel-runtime/helpers/asyncToGenerator'], function (_export, _context) {
    "use strict";
                        ...
                        return _regeneratorRuntime.wrap(function _callee$(_context2) {
                            while (1) {
                                switch (_context2.prev = _context2.next) {
                                    case 0:
                                        _context2.next = 2;
                                        return db.revokedToken.create(req.token.value, req.token.payload.exp);
