...
System.register('bso-server/api/episode/readOrphan', ['babel-runtime/regenerator', 'babel-runtime/helpers/asyncToGenerator', '../helpers/fail'], function (_export, _context) {
  "use strict";
              ...
              while (1) {
                switch (_context2.prev = _context2.next) {
                  case 0:
                    ...
                    _context2.prev = 1;
                    _context2.next = 4;
                    return db.episode.find({ series: null });
